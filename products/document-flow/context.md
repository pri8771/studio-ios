...
- Processing: deterministic text-fixture classification, extraction, and validation are locally verified. English PNG/JPEG OCR is locally verified with Tesseract. Text PDFs use `pdftotext`; scanned PDF pages use local rendering plus Tesseract.
